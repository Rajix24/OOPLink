    ...
    <div class="container">
        <form action="{{ route('article.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" value="{{ $article->title }}" name="title" class="form-control" placeholder="Enter title" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="body" class="form-control" rows="5" placeholder="Main content">value="{{ $article->body }}"</textarea>
            </div>

            <!-- Conclusion -->
            <div class="mb-3">
                <label class="form-label">Conclusion</label>
                <textarea name="conclusion" class="form-control" rows="3" placeholder="Final thoughts">value="{{ $article->conclusion }}"</textarea>
            </div>
